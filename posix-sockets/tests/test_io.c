...
TEST test_posix_recv(void) {
    SKIP(); /* Generated stub for posix_recv */
}
...
TEST test_posix_recvmsg(void) {
    SKIP(); /* Generated stub for posix_recvmsg */
}

TEST test_posix_send(void) {
    SKIP(); /* Generated stub for posix_send */
}

TEST test_posix_sendmsg(void) {
    SKIP(); /* Generated stub for posix_sendmsg */
}

TEST test_posix_sendto(void) {
    SKIP(); /* Generated stub for posix_sendto */
}
