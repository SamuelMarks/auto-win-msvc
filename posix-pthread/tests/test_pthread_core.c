...
TEST test_pthread_equal(void) {
    SKIP(); /* Generated stub for pthread_equal */
}

TEST test_pthread_exit(void) {
    SKIP(); /* Generated stub for pthread_exit */
}
...
TEST test_pthread_join(void) {
    SKIP(); /* Generated stub for pthread_join */
}

TEST test_pthread_once(void) {
    SKIP(); /* Generated stub for pthread_once */
}

TEST test_pthread_self(void) {
    SKIP(); /* Generated stub for pthread_self */
}
