...
TEST test_getitimer(void) {
    SKIP(); /* Generated stub for getitimer */
}

TEST test_gettimeofday(void) {
    SKIP(); /* Generated stub for gettimeofday */
}

TEST test_setitimer(void) {
    SKIP(); /* Generated stub for setitimer */
}

TEST test_utimes(void) {
    SKIP(); /* Generated stub for utimes */
}

TEST test_clock_gettime(void) {
    SKIP(); /* Generated stub for clock_gettime */
}

TEST test_nanosleep(void) {
    SKIP(); /* Generated stub for nanosleep */
}

TEST test_localtime_r(void) {
    SKIP(); /* Generated stub for localtime_r */
}
