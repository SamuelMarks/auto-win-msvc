...
## Implemented Symbols
- [ ] `opendir` (TODO: Polyfill with FindFirstFile)
- [ ] `readdir` (TODO: Polyfill with FindNextFile)
- [ ] `closedir` (TODO: Polyfill with FindClose)
- [ ] `rewinddir` (TODO: Polyfill with FindFirstFile)
- [ ] `seekdir` (TODO: Polyfill with Win32 API)
- [ ] `telldir` (TODO: Polyfill with Win32 API)
- [ ] `scandir` (TODO: Polyfill with Win32 API)
- [ ] `alphasort` (TODO: Polyfill with Win32 API)
