 ...
 * @return 0 if the string matches the pattern, FNM_NOMATCH if there is no match, or another non-zero value if there is an error.
 */
 ...
 * 
 * @param pwordexp Pointer to a wordexp_t structure previously passed to wordexp.
 */
