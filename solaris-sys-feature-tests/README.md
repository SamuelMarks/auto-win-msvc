...
FetchContent_Declare(
    ...
    GIT_TAG        master
    SOURCE_SUBDIR  solaris-sys-feature-tests
)
FetchContent_MakeAvailable(solaris-sys-feature-tests)

# Link against the individual module
target_link_libraries(your_target PRIVATE solaris-sys-feature-tests)
```
