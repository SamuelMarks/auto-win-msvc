...
__declspec(dllimport) WIN_HMODULE
    __stdcall GetModuleHandleA(WIN_LPCSTR lpModuleName);
__declspec(dllimport) WIN_HMODULE
    __stdcall LoadLibraryA(WIN_LPCSTR lpLibFileName);
__declspec(dllimport) WIN_FARPROC
    __stdcall GetProcAddress(WIN_HMODULE hModule, WIN_LPCSTR lpProcName);
