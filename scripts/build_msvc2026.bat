@echo off
setlocal
set "TC_NAME=msvc2026"
set "RES_FILE=%~dp0results_%TC_NAME%.txt"
if exist "%RES_FILE%" del "%RES_FILE%"

set "VCVARS="
for %%E in (Enterprise Professional Community BuildTools) do (
    if exist "C:\Program Files\Microsoft Visual Studio\18\%%E\VC\Auxiliary\Build\vcvarsall.bat" (
        set "VCVARS=C:\Program Files\Microsoft Visual Studio\18\%%E\VC\Auxiliary\Build\vcvarsall.bat"
    )
)
