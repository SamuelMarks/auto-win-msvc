...
TEST test_openat(void) {
    SKIP(); /* Generated stub for openat */
}
...
TEST test_fdatasync(void) {
    SKIP(); /* Generated stub for fdatasync */
}

TEST test_pipe(void) {
    SKIP(); /* Generated stub for pipe */
}

TEST test_pipe2(void) {
    SKIP(); /* Generated stub for pipe2 */
}

TEST test_pread(void) {
    SKIP(); /* Generated stub for pread */
}

TEST test_pwrite(void) {
    SKIP(); /* Generated stub for pwrite */
}

TEST test_readlink(void) {
    SKIP(); /* Generated stub for readlink */
}

TEST test_readlinkat(void) {
    SKIP(); /* Generated stub for readlinkat */
}

TEST test_sync(void) {
    SKIP(); /* Generated stub for sync */
}
